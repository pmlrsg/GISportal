...
left:1,"z-index":9999,width:1});b._trigger("beforeMinimize");b._saveSnapshot();b.uiDialog.css({"float":"left",margin:1,position:"static"});b.uiDialog.appendTo(c);b.uiDialog.css({width:200});b.uiDialog.css("height","auto");b.uiDialog.find(".ui-dialog-titlebar").each(function(){var c=b.uiDialog.find(".ui-dialog-titlebar-buttonpane"),e=b.uiDialog.find(".ui-dialog-title");a(e).css({overflow:"hidden",width:a(this).width()-a(c).width()+10})}).end();b.uiDialog.find(".ui-dialog-content").hide();b.uiDialog.find(".ui-dialog-buttonpane:visible").hide().end().find(".ui-dialog-titlebar").css("white-space",
...
this.close(b);else if(b.keyCode===a.ui.keyCode.TAB){var c=this.uiDialog.find(":tabbable"),f=c.filter(":first"),c=c.filter(":last");if((b.target===c[0]||b.target===this.uiDialog[0])&&!b.shiftKey)f.focus(1),b.preventDefault();else if((b.target===f[0]||b.target===this.uiDialog[0])&&b.shiftKey)c.focus(1),b.preventDefault()}},mousedown:function(a){this.isMinimised()||this._moveToTop(a)&&this._focusTabbable()}});this.element.find("[aria-describedby]").length||this.uiDialog.attr({"aria-describedby":this.element.uniqueId().attr("id")})},
...
c.push({text:"close",icons:{primary:"ui-icon-closethick"},click:function(a){a.preventDefault();b.close(a)},classes:"ui-dialog-titlebar-close"}));a.each(c,function(c,e,i,j){var k,i=a.isFunction(e)?{click:i,text:c,icon:e,classes:j}:e,i=a.extend({type:"button"},i);k=i.click;i.click=function(){k.apply(b.element[0],arguments)};c={icons:i.icons,text:!1};delete i.icons;delete i.showText;a("<button></button>",i).button(c).addClass(i.classes).appendTo(b.uiDialogTitlebarButtonPane)});b.uiDialogTitlebarButtonPane.find(".ui-dialog-titlebar-restore").hide()},
_makeDraggable:function(){function b(a){return{position:a.position,offset:a.offset}}var c=this,f=this.options;this.uiDialog.draggable({cancel:".ui-dialog-content, .ui-dialog-titlebar-close",handle:".ui-dialog-titlebar",containment:"document",start:function(f,i){a(this).addClass("ui-dialog-dragging");c._blockFrames();c._trigger("dragStart",f,b(i))},drag:function(a,f){c._trigger("drag",a,b(f))},stop:function(g,i){f.position=[i.position.left-c.document.scrollLeft(),i.position.top-c.document.scrollTop()];
a(this).removeClass("ui-dialog-dragging");c._unblockFrames();c._trigger("dragStop",g,b(i))}})},_makeResizable:function(){function b(a){return{originalPosition:a.originalPosition,originalSize:a.originalSize,position:a.position,size:a.size}}var c=this,f=this.options,g=f.resizable,i=this.uiDialog.css("position"),g="string"===typeof g?g:"n,e,s,w,se,sw,ne,nw";this.uiDialog.resizable({cancel:".ui-dialog-content",containment:"document",alsoResize:this.element,maxWidth:f.maxWidth,maxHeight:f.maxHeight,minWidth:f.minWidth,
minHeight:this._minHeight(),handles:g,start:function(f,g){a(this).addClass("ui-dialog-resizing");c._blockFrames();c._trigger("resizeStart",f,b(g))},resize:function(a,f){c._trigger("resize",a,b(f))},stop:function(g,i){f.height=a(this).height();f.width=a(this).width();a(this).removeClass("ui-dialog-resizing");c._unblockFrames();c._trigger("resizeStop",g,b(i))}}).css("position",i)},_minHeight:function(){var a=this.options;return"auto"===a.height?a.minHeight:Math.min(a.minHeight,a.height)},_position:function(){var a=
this.uiDialog.is(":visible");a||this.uiDialog.show();this.uiDialog.position(this.options.position);a||this.uiDialog.hide()},_setOptions:function(d){var e=this,f=!1,g={};a.each(d,function(a,d){e._setOption(a,d);a in b&&(f=!0);a in c&&(g[a]=d)});f&&(this._size(),this._position());this.uiDialog.is(":data(ui-resizable)")&&this.uiDialog.resizable("option",g)},_setOption:function(a,b){var c,g=this.uiDialog;"dialogClass"===a&&g.removeClass(this.options.dialogClass).addClass(b);"disabled"!==a&&(this._super(a,
...
this.document.unbind("focusin.dialog"),this.overlay.remove(),this.overlay=null)}});a.ui.dialog.overlayInstances=0;!1!==a.uiBackCompat&&a.widget("opec.extendedDialog",a.opec.extendedDialog,{_position:function(){var b=this.options.position,c=[],f=[0,0],g;if(b){if("string"===typeof b||"object"===typeof b&&"0"in b)c=b.split?b.split(" "):[b[0],b[1]],1===c.length&&(c[1]=c[0]),a.each(["left","top"],function(a,b){+c[a]===c[a]&&(f[a]=c[a],c[a]=b)}),b={my:c[0]+(0>f[0]?f[0]:"+"+f[0])+" "+c[1]+(0>f[1]?f[1]:"+"+
f[1]),at:c.join(" ")};b=a.extend({},a.ui.dialog.prototype.options.position,b)}else b=a.ui.dialog.prototype.options.position;(g=this.uiDialog.is(":visible"))||this.uiDialog.show();this.uiDialog.position(b);g||this.uiDialog.hide()}})})(jQuery);var opec=opec||(opec={}),map;opec.cache={};opec.cache.wmsLayers=[];opec.cache.wfsLayers=[];opec.loadLayers=function(){var a=function(a,c,d){gritterErrorHandler({type:"master cache",request:a,errorType:c,exception:d,url:this.url})};opec.genericAsyc("./cache/mastercache.json",opec.initWMSlayers,a,"json",{});opec.genericAsyc("./cache/wfsMasterCache.json",opec.initWFSLayers,a,"json",{})};
opec.getFeature=function(a,b){var c=$.param({baseurl:a.url,request:"GetFeature",version:"1.1.0",featureID:a.WFSDatesToIDs[b],typeName:a.urlName});opec.genericAsyc(map.pywfsLocation+c,function(b){var b=b.output,c=b.position.split(" "),f=new OpenLayers.Geometry.Point(c[1],c[0]),b=new OpenLayers.Feature.Vector(f,{message:$("<div/>").html(b.content).html(),location:"Lon: "+c[1]+" Lat: "+c[0]});a.addFeatures(b)},function(a,b,c){gritterErrorHandler({type:"getFeature",request:a,errorType:b,exception:c,url:this.url})},
"json",{layer:a})};opec.genericAsyc=function(a,b,c,d,e){$.ajax({type:"GET",url:a,dataType:d,asyc:!0,cache:!1,success:function(a){b(a,e)},error:c})};
opec.MicroLayer=function(a,b,c,d,e,f,g,i,j,k){this.origName=a.replace("/","-");this.name=a.replace("/","-");this.urlName=a;this.displayTitle=b.replace(/_/g," ");this.title=b;this.productAbstract=c;this.firstDate=d;this.lastDate=e;this.serverName=f;this.wmsURL=g;this.wcsURL=i;this.sensorNameDisplay=j.replace(/\s+/g,"");this.sensorName=j.replace(/[\.,]+/g,"");this.exBoundingBox=k};
var lonlat=new OpenLayers.Projection("EPSG:4326"),quickRegion=[["Choose a Region",-150,-90,150,90],["World View",-150,-90,150,90],["European Seas",-23.44,20.14,39.88,68.82],["Adriatic",11.83,39,20.67,45.8],["Baltic",9,51.08,30.5,67.62],["Biscay",-10,43,0,49],["Black Sea",27.3,38.5,42,49.8],["English Channel",-5,46.67,4.3,53.83],["Eastern Med.",20,29.35,36,41.65],["North Sea",-4.5,50.2,8.9,60.5],["Western Med.",-6,30.8,16.5,48.1],["Mediterranean",-6,29.35,36,48.1]];OpenLayers.ProxyHost="/service/proxy?url=";
...
opec.createRefLayers=function(){opec.leftPanel.addGroupToPanel("refLayerGroup","Reference Layers",$("#opec-lPanel-reference"));$.each(opec.cache.wfsLayers,function(a,b){if("undefined"!==typeof b.url&&"undefined"!==typeof b.serverName&&"undefined"!==typeof b.layers){var c=b.url;$.each(b.layers,function(a,b){if("undefined"!==b.times&&"undefined"!==typeof b.name){var d=new OpenLayers.Layer.Vector(b.name,{projection:lonlat,styleMap:new OpenLayers.StyleMap({"default":{strokeColor:"#00FF00",strokeOpacity:1,
strokeWidth:3,fillColor:"#FF5500",fillOpacity:0.5,pointRadius:6,pointerEvents:"visiblePainted",fontSize:"12px",fontFamily:"Courier New, monospace",fontWeight:"bold",labelOutlineColor:"white",labelOutlineWidth:3}}),eventListeners:{featureselected:function(a){var a=a.feature,b=new OpenLayers.Popup.FramedCloud("popup",OpenLayers.LonLat.fromString(a.geometry.toShortString()),null,a.attributes.message+"<br>"+a.attributes.location,null,!0,null);b.autoSize=!0;b.maxSize=new OpenLayers.Size(400,500);b.fixedRelativePosition=
!0;a.popup=b;map.addPopup(b)},featureunselected:function(a){a=a.feature;map.removePopup(a.popup);a.popup.destroy();a.popup=null}}},{typeName:b.name,format:"image/png",transparent:!0,exceptions:"XML",version:"1.0",layers:"1"});opec.mapControls.selector.setLayer(d);if(b.times&&b.times.length){d.temporal=!0;for(var e=[],l={},m=0;m<b.times.length;m++){var n=b.times[m];e.push(n.startdate);l[n.startdate]=n.id}d.DTCache=e;d.WFSDatesToIDs=l}d.urlName=b.name.replace("-",":");d.controlID="refLayers";d.setVisibility(!1);
d.displayTitle=b.name;d.url=c;map.addLayer(d);opec.leftPanel.addLayerToGroup(d,$("#refLayerGroup"))}})}});for(var a=function(a){var b={"AMT 12 track":"blue","AMT 13 track":"aqua","AMT 14 track":"lime","AMT 15 track":"magenta","AMT 16 track":"red","AMT 17 track":"orange","AMT 19 track":"yellow"};if($.inArray(a,b))return b[a.attributes.Name]},b=12;19>=b;b++)if(18!=b){var c=new OpenLayers.Style({strokeColor:"${colour}"},{context:{colour:a}}),c=new OpenLayers.StyleMap({"default":c}),c=new OpenLayers.Layer.Vector("AMT"+
b+"_Cruise_Track",{protocol:new OpenLayers.Protocol.HTTP({url:"http://rsg.pml.ac.uk/geoserver/rsg/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=rsg:AMT"+b+"&outputFormat=GML2",format:new OpenLayers.Format.GML}),strategies:[new OpenLayers.Strategy.Fixed],projection:lonlat,styleMap:c});c.controlID="refLayers";c.setVisibility(!1);c.displayTitle="AMT"+b+" Cruise Track";map.addLayer(c);opec.leftPanel.addLayerToGroup(c,$("#refLayerGroup"))}a=new OpenLayers.Layer.Vector("The_Black_Sea_KML",{projection:lonlat,
strategies:[new OpenLayers.Strategy.Fixed],protocol:new OpenLayers.Protocol.HTTP({url:"black_sea.kml",format:new OpenLayers.Format.KML({extractStyles:!0,extractAttributes:!0})})});a.controlID="refLayers";a.selected=!0;a.displayTitle="The Black Sea (KML)";map.addLayer(a);opec.leftPanel.addLayerToGroup(a,$("#refLayerGroup"));map.numRefLayers=map.getLayersBy("controlID","refLayers").length};
opec.createOpLayers=function(){$.each(opec.cache.wmsLayers,function(a,b){if("undefined"!==typeof b.server&&"undefined"!==typeof b.wmsURL&&"undefined"!==typeof b.wcsURL&&"undefined"!==typeof b.serverName){var c=b.wmsURL,d=b.wcsURL,e=b.serverName;$.each(b.server,function(a,b){b.length&&$.each(b,function(b,g){if(g.Name&&""!==g.Name){var k=new opec.MicroLayer(g.Name,g.Title,g.Abstract,g.FirstDate,g.LastDate,e,c,d,a,g.EX_GeographicBoundingBox);opec.checkNameUnique(k);$("#layers").multiselect("addItem",
{text:k.name,title:k.displayTitle,selected:opec.isSelected})}})})}})};opec.isSelected=function(a){if(map)return-1<$.inArray(a,map.sampleLayers)?!0:!1};opec.checkNameUnique=function(a,b){var c=null;"undefined"===typeof b||0===b?(c=a.name,b=0):c=a.name+b;c in map.microLayers?opec.checkNameUnique(a,++b):0!==b&&(a.name+=b);map.microLayers[a.name]=a};
opec.createOpLayer=function(a,b){var c=new OpenLayers.Layer.WMS(b.name,b.wmsURL,{layers:b.urlName,transparent:!0},{opacity:1,wrapDateLine:!0,transitionEffect:"resize"});$.each(a.Dimensions,function(a,b){if("time"==b.Name.toLowerCase()){c.temporal=!0;var f=b.Value.split(",");c.DTCache=f;c.firstDate=opec.utils.displayDateString(f[0]);c.lastDate=opec.utils.displayDateString(f[f.length-1])}else"elevation"==b.Name.toLowerCase()&&(c.elevation=!0,c.elevationCache=b.Value.split(","),c.mergeNewParams({elevation:b.Default}),
c.elevationDefault=b.Default,c.elevationUnits=b.Units)});c.origName=b.origName;c.urlName=b.urlName;c.displayTitle=b.displayTitle;c.title=b.title;c.productAbstract=b.productAbstract;c.displaySensorName=b.sensorNameDisplay;c.sensorName=b.sensorName;c.wcsURL=b.wcsURL;c.styles=a.Styles;c.exBoundingBox=b.exBoundingBox;c.boundingBox=a.BoundingBox;c.setVisibility(!1);c.selected=!1;map.layerStore[c.name]=c;map.getMetadata(c)};
opec.addOpLayer=function(a){var b=map.layerStore[a];"undefined"===typeof b||"null"==b?console.log("Error: Could not get a layer object"):(delete map.layerStore[a],map.addLayer(b),map.setLayerIndex(b,map.numBaseLayers+map.numOpLayers),map.events.register("click",b,getFeatureInfo),opec.leftPanel.addLayerToGroup(b,opec.leftPanel.getFirstGroupFromPanel($("#opec-lPanel-operational"))),map.numOpLayers++)};
opec.removeOpLayer=function(a){opec.leftPanel.removeLayerFromGroup(a);map.removeLayer(a);map.events.unregister("click",a,getFeatureInfo);map.layerStore[a.name]=a;map.numOpLayers--};opec.customPermalinkArgs=function(){OpenLayers.Control.Permalink.prototype.createParams.apply(this,arguments)};opec.checkLayerState=function(a){!a.visibility&&a.selected?$("#"+a.name).find('img[src="img/exclamation_small.png"]').show():$("#"+a.name).find('img[src="img/exclamation_small.png"]').hide()};
...
$(window).height()-350)});$("#opec-lPanel-content").on("mousedown","li",function(){var a=$(this);a.hasClass("notSelectable")||(a.children("input").first(),$(".opec-layer:visible").each(function(){$(this).removeClass("selectedLayer")}),a.addClass("selectedLayer"),$(this).trigger("selectedLayer"))});$("#opec-lPanel-operational, #opec-lPanel-reference").on("click",":checkbox",function(){var a=$(this).val(),a=map.getLayersByName(a)[0];if($(this).is(":checked"))if(a.selected=!0,a.temporal){map.selectDateTimeLayer(a,
$("#viewDate").datepicker("getDate"));var b=$.datepicker.parseDate("dd-mm-yy",a.firstDate),c=$.datepicker.parseDate("dd-mm-yy",a.lastDate);t1.addTimeBar(a.name,a.title,b,c,a.DTCache);map.refreshDateCache();$("#viewDate").datepicker("option","defaultDate",$.datepicker.parseDate("dd-mm-yy",a.lastDate))}else a.setVisibility(!0),opec.checkLayerState(a);else a.selected=!1,a.setVisibility(!1),opec.checkLayerState(a),a.temporal&&(t1.removeTimeBarByName(a.name),map.refreshDateCache())});map.events.register("mousemove",
...
b){if(b.option.text in map.microLayers){var c=map.microLayers[b.option.text];b.option.text in map.layerStore?opec.addOpLayer(b.option.text):map.getLayerData(c.serverName+"_"+c.origName+".json",c)}else console.log("no layer data to use")},deselected:function(a,b){var c=map.getLayersByName(b.option.text)[0];c?opec.removeOpLayer(c):map.layerStore[b.option.text]||console.log("no layer data to use")},addall:function(a,b){if(50<a.availableList.children("li.ui-element:visible").length){var c=$('<div id="warning" title="You sure about this?"><p><span class="ui-icon ui-icon-alert" style="float: left; margin: 0 7px 50px 0;"></span>Adding lots of layers may cause the browser to slow down. Are you sure you want to proceed?</p></div>');
...
function getFeatureInfo(a){if(this.visibility&&map.getControlsByClass("OpenLayers.Control.Navigation")[0].active){var b=new OpenLayers.Pixel(a.xy.x,a.xy.y),c=map.getLonLatFromPixel(b);if(!this.isBaseLayer){if("undefined"!==typeof this.options.clickable&&!this.options.clickable)return null;var d=new OpenLayers.Pixel(b.x+10,b.y+10),e=new OpenLayers.Pixel(b.x-10,b.y-10);(b=this.options.bbox)&&0<b.length&&(b=b[0]);var f=new OpenLayers.Bounds;if(b)if(b.lowercorner&&b.uppercorner){var g=b.lowercorner.split(" "),
i=b.uppercorner.split(" ");f.extend(new OpenLayers.LonLat(g[0],g[1]));f.extend(new OpenLayers.LonLat(i[0],i[1]))}else b.maxx&&(b.maxy&&b.minx&&b.miny)&&(f.extend(new OpenLayers.LonLat(b.minx,b.miny)),f.extend(new OpenLayers.LonLat(b.maxx,b.maxy)));g=new OpenLayers.Bounds;g.extend(map.getLonLatFromPixel(d));g.extend(map.getLonLatFromPixel(e));e=map.getLonLatFromPixel(e);d=map.getLonLatFromPixel(d);if(g.intersectsBounds(f)||!b){var j=new OpenLayers.Popup("temp",c,new OpenLayers.Size(100,50),"Loading...",
!0,null);j.autoSize=!0;map.addPopup(j);b=d.lat+","+e.lon+","+e.lat+","+d.lon;b=d="";this.url.contains("1.0RC3")?(d="&X=",b="&Y="):(d="&I=",b="&J=");$.ajax({type:"GET",url:OpenLayers.ProxyHost+this.url+encodeURIComponent("request=GetFeatureInfo&service=wms&layers="+this.urlName+"&QUERY_LAYERS="+this.urlName+"&version=1.1.1&bbox="+map.getExtent().toBBOX()+"&time="+this.params.TIME+"&elevation="+this.params.ELEVATION+d+a.xy.x+b+a.xy.y+"&SRS=EPSG:4326&INFO_FORMAT=text/xml&WIDTH="+map.size.w+"&HEIGHT="+
map.size.h),dataType:"xml",asyc:!0,success:function(a){console.log(a);var b=parseFloat(getElementValue(a,"longitude")),d=parseFloat(getElementValue(a,"latitude")),a=parseFloat(getElementValue(a,"value")),f="";b&&(d&&a)&&(a=a.toPrecision(4),f="<b>Lon:</b> "+b.toFixed(6)+"<br /><b>Lat:</b> "+d.toFixed(6)+"<br /><b>Value:</b> "+a+"<br />");map.removePopup(j);b=new OpenLayers.Popup("id",c,new OpenLayers.Size(100,50),f,!0,null);b.autoSize=!0;map.addPopup(b)},error:function(a,b,c){gritterErrorHandler({type:"master cache",
...
function addDThreeGraph(){var a=d3.time.format("%Y-%m-%dT%H:%M:%S").parse,b=d3.time.scale().range([0,830]),c=d3.scale.linear().range([450,0]),d=d3.scale.category10(),e=d3.svg.axis().scale(b).orient("bottom"),f=d3.svg.axis().scale(c).orient("left"),g=d3.svg.line().interpolate("basis").x(function(a){return b(a.date)}).y(function(a){return c(a.temperature)}),i=d3.select("#dThree").append("svg").attr("width",960).attr("height",500).append("g").attr("transform","translate(50,20)");d3.tsv("data.tsv",function(j,
...
opec.window.getWindow=function(){};opec.window.createScalebar=function(a){var b=map.getLayersByName(a.attr("id"))[0],a=getScalebarDetails(b);$("#scalebar-"+b.name).length&&$("#scalebar-"+b.name).extendedDialog("close");a={name:b.name,displayTitle:b.displayTitle,url:a.url};$(document.body).append(opec.templates.scalebarWindow(a));"undefined"!==typeof b.minScaleVal&&"undefined"!==typeof b.maxScaleVal?($("#"+b.name+"-max").val(b.maxScaleVal),$("#"+b.name+"-min").val(b.minScaleVal)):($("#"+b.name+"-max").val="",$("#"+b.name+"-min").val=
"");$("#scalebar-"+b.name).extendedDialog({position:["center","center"],width:310,resizable:!1,autoOpen:!1,showHelp:!0,showMinimise:!0,dblclick:"collapse",close:function(){$("#scalebar-"+b.name).remove()},restore:function(){$(this).trigger("resize")},help:function(){opec.gritter.showNotification("scalebarTutorial",null)}});$("#"+b.name+"-log").on("click",":checkbox",function(){if(!b.log||!$(this).is(":checked"))(!1!==b.log||$(this).is(":checked"))&&validateScale(b,null,null)});$("#"+b.name+"-reset").on("click",
'[type="button"]',function(){validateScale(b,b.origMinScaleVal,b.origMaxScaleVal,!0)});$("#"+b.name+"-scale").on("click",'[type="button"]',function(){var a=getScaleRange(b.minScaleVal,b.maxScaleVal);$("#"+b.name+"-range-slider").slider("option","min",a.min);$("#"+b.name+"-range-slider").slider("option","max",a.max);validateScale(b,b.minScaleVal,b.maxScaleVal)});$("#"+b.name+"-max").focusout(function(){var a=parseFloat($(this).val());a!=b.maxScaleVal&&validateScale(b,null,a)});$("#"+b.name+"-min").focusout(function(){var a=
parseFloat($(this).val());a!=b.minScaleVal&&validateScale(b,a,null)});a=getScaleRange(b.minScaleVal,b.maxScaleVal);$("#"+b.name+"-range-slider").slider({orientation:"vertical",range:!0,values:[b.minScaleVal,b.maxScaleVal],max:a.max,min:a.min,step:1E-8,change:function(){($(this).slider("values",0)!=b.minScaleVal||$(this).slider("values",1)!=b.maxScaleVal)&&validateScale(b,$(this).slider("values",0),$(this).slider("values",1))}});$("#"+b.name+"-range-slider").css({height:256,margin:"5px 0px 0px 10px"});
$("#scalebar-"+b.name).extendedDialog("open")};function updateScalebar(a){if($("#scalebar-"+a.name).length){var b=getScalebarDetails(a);$("#scalebar-"+a.name+"> img").attr("src",b.url);a.mergeNewParams({colorscalerange:a.minScaleVal+","+a.maxScaleVal,logscale:a.log});console.info("url: "+b.url)}}
function getScalebarDetails(a){var b=null,c=110,d=256;$.each(a.styles,function(e,f){if(f.Name==a.params.STYLES&&null===b)return b=f.LegendURL+createGetLegendURL(a,!0),c=parseInt(f.Width,10),d=parseInt(f.Height,10),!1});null===b&&(b=createGetLegendURL(a,!1));return{url:b,width:c,height:d}}function getScaleRange(a,b){return{max:b+Math.abs(25*(b/100)),min:a-Math.abs(25*(b/100))}}
function validateScale(a,b,c,d){if(null===b||"undefined"===typeof b)b=a.minScaleVal;if(null===c||"undefined"===typeof c)c=a.maxScaleVal;if(null===d||"undefined"===typeof d)d=!1;b=parseFloat(b);c=parseFloat(c);if(isNaN(b))alert("Scale limits must be set to valid numbers"),$("#"+a.name+"-min").val(a.minScaleVal),$("#"+a.name+"-range-slider").slider("values",0,a.minScaleVal);else if(isNaN(c))alert("Scale limits must be set to valid numbers"),$("#"+a.name+"-max").val(a.maxScaleVal),$("#"+a.name+"-range-slider").slider("values",
1,a.maxScaleVal);else if(b>c)alert("Minimum scale value must be less than the maximum"),$("#"+a.name+"-min").val(a.minScaleVal),$("#"+a.name+"-max").val(a.maxScaleVal);else if(0>=b&&$("#"+a.name+"-log").children('[type="checkbox"]').first().is(":checked"))alert("Cannot use a logarithmic scale with negative or zero values"),$("#"+a.name+"-log").children('[type="checkbox"]').attr("checked",!1),$("#"+a.name+"-range-slider").slider("values",0,a.minScaleVal);else{$("#"+a.name+"-min").val(b);$("#"+a.name+
"-max").val(c);if(b<$("#"+a.name+"-range-slider").slider("option","min")||c>$("#"+a.name+"-range-slider").slider("option","max")||!0===d)d=getScaleRange(b,c),$("#"+a.name+"-range-slider").slider("option","min",d.min),$("#"+a.name+"-range-slider").slider("option","max",d.max),console.log("scale changed");a.minScaleVal=b;a.maxScaleVal=c;a.log=$("#"+a.name+"-log").children('[type="checkbox"]').first().is(":checked")?!0:!1;$("#"+a.name+"-range-slider").slider("values",0,b);$("#"+a.name+"-range-slider").slider("values",
1,c);updateScalebar(a)}}function createGetLegendURL(a,b){return b?"&COLORSCALERANGE="+a.minScaleVal+","+a.maxScaleVal+"&logscale="+a.log:a.url+"REQUEST=GetLegendGraphic&LAYER="+a.urlName+"&COLORSCALERANGE="+a.minScaleVal+","+a.maxScaleVal+"&logscale="+a.log};opec.window.createGraphCreator=function(){var a=$("#graphCreator");a.length&&a.extendedDialog("close");$(document.body).append(opec.templates.graphCreatorWindow({advanced:!0}));var a=$("#graphCreator"),b=a.find("#graphcreator-generate").first();a.extendedDialog({position:["center","center"],width:340,resizable:!1,autoOpen:!1,close:function(){$("#graphCreator").remove()},showHelp:!0,showMinimise:!0,dblclick:"collapse",help:function(){opec.gritter.showNotification("graphCreatorTutorial",null)}});$("#graphcreator-time, #graphcreator-time2").datepicker({showButtonPanel:!0,
dateFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});var c=$("#viewDate").datepicker("getDate");""!==c&&($("#graphcreator-time").datepicker("setDate",c),$("#graphcreator-time2").datepicker("setDate",c));c=map.getLayersByName($(".selectedLayer:visible").attr("id"))[0];$("#graphcreator-baseurl").val(c.wcsURL);$("#graphcreator-coverage").val(c.origName);$(".lPanel").bind("selectedLayer",function(){var a=map.getLayersByName($(".selectedLayer:visible").attr("id"))[0];$("#graphcreator-baseurl").val(a.wcsURL);
$("#graphcreator-coverage").val(a.origName)});b.find('img[src="img/ajax-loader.gif"]').hide();$("#graphcreator-bbox").click(function(){opec.gritter.showNotification("bbox",null)});$(".ui-control-header").click(function(){$(this).toggleClass("ui-control-header-active").find("> .ui-icon").toggleClass("ui-icon-triangle-1-e ui-icon-triangle-1-s").end().next().toggleClass("ui-control-content-active").slideToggle();return!1});$("#graphcreator-coverage-button").click(function(){$.each($(".sensor-accordion").children("li").children(":checkbox").get().reverse(),
function(){if($(this).is(":checked")){var a=$(this).parent("li").attr("id"),a=map.getLayersByName(a)[0];$("#graphcreator-coverage").val(a.origName);$("#graphcreator-baseurl").val(a.wcsURL)}});return!1});a.unbind(".loadGraph").bind("ajaxStart.loadGraph",function(){$(this).find('img[src="img/ajax-loader.gif"]').show()}).bind("ajaxStop.loadGraph",function(){$(this).find('img[src="img/ajax-loader.gif"]').hide()});$("#graphcreator-barwidth-button").click(function(){return!1});$("#histogram-inputs-header").trigger("click");
$("#advanced-inputs-header").trigger("click");$("#graph-format-header").trigger("click");b.on("click",":button",function(){var a=$("#graphcreator-time").val();""!==$("#graphcreator-time2").val()&&(a+="/"+$("#graphcreator-time2").val());var b=null,c=null;"hovmollerLon"==$("#graphcreator-type").val()?(b="Lon",c="Time"):"hovmollerLat"==$("#graphcreator-type").val()&&(b="Time",c="Lat");a={baseurl:$("#graphcreator-baseurl").val(),coverage:$("#graphcreator-coverage").val(),type:$("#graphcreator-type").val(),
bins:$("#graphcreator-bins").val(),time:a,bbox:$("#graphcreator-bbox").val(),graphXAxis:b,graphYAxis:c,graphZAxis:$("#graphcreator-coverage").val()};a=$.param(a);$.ajax({type:"GET",url:map.host+map.pywcsLocation+a,dataType:"json",asyc:!0,success:function(a){opec.graphs.create(a)},error:function(a,b,c){gritterErrorHandler({type:"wcs data",request:a,errorType:b,exception:c,url:this.url})}})});a.extendedDialog("open")};
...
"center"],width:340,resizable:!1,autoOpen:!1,close:function(){$("#"+d.uid).remove()},showHelp:!0,showMinimise:!0,dblclick:"collapse",help:function(){opec.gritter.showNotification("graphCreatorTutorial",null)}});this.logic();graphCreator.extendedDialog("open");return d},logic:function(){var a=window.$instance.find("#graphcreator-generate").first();$("#graphcreator-time, #graphcreator-time2").datepicker({showButtonPanel:!0,dateFormat:"yy-mm-dd",changeMonth:!0,changeYear:!0});var b=map.getLayersByName($(".selectedLayer:visible").attr("id"))[0];
$("#graphcreator-baseurl").val(b.wcsURL);$("#graphcreator-coverage").val(b.origName);$(".lPanel").bind("selectedLayer",function(){var a=map.getLayersByName($(".selectedLayer:visible").attr("id"))[0];$("#graphcreator-baseurl").val(a.wcsURL);$("#graphcreator-coverage").val(a.origName)});a.find('img[src="img/ajax-loader.gif"]').hide();$("#graphcreator-bbox").click(function(){opec.gritter.showNotification("bbox",null)});$(".ui-control-header").click(function(){$(this).toggleClass("ui-control-header-active").find("> .ui-icon").toggleClass("ui-icon-triangle-1-e ui-icon-triangle-1-s").end().next().toggleClass("ui-control-content-active").slideToggle();
...
$("#graphcreator-barwidth-button").click(function(){return!1});$("#histogram-inputs-header").trigger("click");$("#advanced-inputs-header").trigger("click");$("#graph-format-header").trigger("click");a.on("click",":button",function(){var a=$("#graphcreator-time").val();""!==$("#graphcreator-time2").val()&&(a+="/"+$("#graphcreator-time2").val());var b=null,e=null;"hovmollerLon"==$("#graphcreator-type").val()?(b="Lon",e="Time"):"hovmollerLat"==$("#graphcreator-type").val()&&(b="Time",e="Lat");a={baseurl:$("#graphcreator-baseurl").val(),
coverage:$("#graphcreator-coverage").val(),type:$("#graphcreator-type").val(),bins:$("#graphcreator-bins").val(),time:a,bbox:$("#graphcreator-bbox").val(),graphXAxis:b,graphYAxis:e,graphZAxis:$("#graphcreator-coverage").val()};a=$.param(a);$.ajax({type:"GET",url:map.host+map.pywcsLocation+a,dataType:"json",asyc:!0,success:function(a){if(""!==a.error)opec.gritter.showNotification("graphError",{error:a.error});else if("basic"==a.type){(new Date(a.output.global.time)).getTime();var b=[],c=[],d=[],e=
[],l=[];$.each(a.output.data,function(a,f){b.push([(new Date(a)).getTime(),f.std]);c.push([(new Date(a)).getTime(),f.max]);d.push([(new Date(a)).getTime(),f.min]);e.push([(new Date(a)).getTime(),f.median]);l.push([(new Date(a)).getTime(),f.mean])});var m={id:"wcsgraph"+Date.now(),title:"WCS Test Graph",data:[{data:b.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"STD"},{data:c.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"max"},{data:d.sort(opec.utils.sortDates),
lines:{show:!0},points:{show:!0},label:"min"},{data:e.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"median"},{data:l.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"mean"}],options:basicTimeOptions(a.output.units),selectable:!0,selectSeries:!0};createGraph(m)}else"histogram"==a.type?(a=a.output.histogram.Numbers,m=Math.abs(a[a.length-1][0]-a[0][0])/a.length,m={id:"wcsgraph"+Date.now(),title:"WCS Test Graph",data:[a],options:barOptions(m),selectable:!1},createGraph(m)):
"hovm\u00f6llerLon"==a.type&&((new Date(a.output.global.time)).getTime(),m={id:"wcsgraph"+Date.now(),title:"WCS Hovm\u00f6ller Test Graph"},hovmoller(m,a.output))},error:function(a,b,c){gritterErrorHandler({type:"wcs data",request:a,errorType:b,exception:c,url:this.url})}})})},destroy:function(){}};opec.window.addWindow(graphCreator);opec.window.createMetadata=function(a){if(null!==a){$("#metadata-"+a.name).length&&$("#metadata-"+a.name).extendedDialog("close");var b={name:a.name,displayTitle:a.displayTitle,northBoundLat:a.exBoundingBox.NorthBoundLatitude,eastBoundLon:a.exBoundingBox.EastBoundLongitude,southBoundLat:a.exBoundingBox.SouthBoundLatitude,westBoundLon:a.exBoundingBox.WestBoundLongitude,addDateRange:a.temporal,productAbstract:a.productAbstract,firstDate:a.firstDate,lastDate:a.lastDate};$(document.body).append(opec.templates.metadataWindow(b));
$("#metadata-"+a.name).extendedDialog({position:["center","center"],width:400,height:250,resizable:!0,autoOpen:!1,close:function(){$("#metadata-"+a.name).remove()},showHelp:!1,showMinimise:!0,dblclick:"collapse"});$("#metadata-"+a.name).extendedDialog("open")}};opec.gritter={};opec.gritter._notifications=[];opec.gritter.tutUID=null;opec.gritter.setup=function(){$.extend($.gritter.options,{position:"bottom-right",fade_in_speed:"medium",fade_out_speed:800,time:6E3});createHelpMessages();createWelcomeMessage();opec.gritter.gritterLayerHelper()};opec.gritter.addNotification=function(a,b){opec.gritter._notifications[a]=b};
...
opec.gritter.gritterLayerHelper=function(){$(document).on("click",'img[src="img/exclamation_small.png"]',function(){var a=$(this).parent().parent().attr("id"),a=map.getLayersByName(a)[0],b="none";if(a.temporal){var c=$("#viewDate").datepicker("getDate");null!==c?(c=opec.utils.ISODateString(new Date(c.selectedYear,c.selectedMonth,c.selectedDay)),null===a.matchDate(c)&&(b="dateNotInRange")):null===c&&(b="noDate")}opec.gritter.showNotification(b,{layer:a});return!1})};
...
opec.graphs.create=function(a){if(""!==a.error)opec.gritter.showNotification("graphError",{error:a.error});else if("basic"==a.type){(new Date(a.output.global.time)).getTime();var b=[],c=[],d=[],e=[],f=[];$.each(a.output.data,function(a,g){b.push([(new Date(a)).getTime(),g.std]);c.push([(new Date(a)).getTime(),g.max]);d.push([(new Date(a)).getTime(),g.min]);e.push([(new Date(a)).getTime(),g.median]);f.push([(new Date(a)).getTime(),g.mean])});a={id:"wcsgraph"+Date.now(),title:"WCS Test Graph",data:[{data:b.sort(opec.utils.sortDates),
lines:{show:!0},points:{show:!0},label:"STD"},{data:c.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"max"},{data:d.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"min"},{data:e.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"median"},{data:f.sort(opec.utils.sortDates),lines:{show:!0},points:{show:!0},label:"mean"}],options:basicTimeOptions(a.output.units),selectable:!0,selectSeries:!0};createGraph(a)}else if("histogram"==a.type){var a=a.output.histogram.Numbers,
...
function createGraph(a){function b(b,c,d){d=Flotr._.extend(Flotr._.clone(a.options),d||{});return Flotr.draw(b,c,d)}function c(a){i=j.getEventPosition(a);Flotr.EventAdapter.observe(document,"mouseup",e);Flotr.EventAdapter.observe(document,"mousemove",d)}function d(d){var f=j.getEventPosition(d),d=j.axes.x,f=i.x-f.x;j=b(g,a.selectSeries?m():a.data,{xaxis:{min:d.min+f,max:d.max+f}});Flotr.EventAdapter.observe(j.overlay,"mousedown",c)}function e(){Flotr.EventAdapter.stopObserving(document,"mousemove",
d)}var f=opec.graphs.createDialogAlt(a.id,a.title);f.children(".graph").width(600).height(384);var g=f.children(".graph").get(0),i,j,k=0;$.each(a.data,function(a,b){b.color=k;++k});if(a.selectSeries&&!0===a.selectSeries){f.append('<div class="choices">Show:</div>');var l=f.children(".choices").css({left:620,top:20,position:"absolute"});$.each(a.data,function(a,b){l.append('<br/><input type="checkbox" name="'+a+'" checked="checked" id="id'+a+'"><label for="id'+a+'">'+b.label+"</label>")});l.find("input").click(function(){j=
...
"xaxis").attr("transform","translate(0,440)").call(j).append("text").attr("y",30).attr("x",290).attr("dy",".71em").style("text-anchor","end").text("Longitude"),d.append("g").attr("class","yaxis"),d.select(".yaxis").call(k).append("text").attr("transform","rotate(270)").attr("y",-80).attr("x",-214.5).attr("dy",".71em").style("text-anchor","end").text("Time"),d.selectAll("rects").data(b.data).enter().append("rect").attr("x",function(a){return g(a[1])}).attr("y",function(a){return i(e(a[0]))}).attr("width",
g.rangeBand()).attr("height",function(){return 8}).style("fill",function(a){return f(0<a[2]?a[2]:0.0010)})):(d.append("g").attr("class","xaxis").attr("transform","translate(0,440)").call(j).append("text").attr("y",30).attr("x",290).attr("dy",".71em").style("text-anchor","end").text("Time"),d.append("g").attr("class","yaxis"),d.select(".yaxis").call(k).append("text").attr("transform","rotate(270)").attr("y",-80).attr("x",-214.5).attr("dy",".71em").style("text-anchor","end").text("Latitude"),d.selectAll("rects").data(b.data).enter().append("rect").attr("x",
function(a){return g(e(a[0]))}).attr("y",function(a){return i(a[1])}).attr("width",function(){return 8}).attr("height",i.rangeBand()).style("fill",function(a){return f(0<a[2]?a[2]:0.0010)}));d.selectAll(".xaxis text").attr("transform","translate("+580/365/2+",0)");a=c.append("defs").append("linearGradient").attr("id","gradient").attr("y1","0%").attr("y1","0%").attr("y2","100%").attr("x2","0%").attr("spreadMethod","pad");a.append("stop").attr("offset","0%").attr("stop-color",f(f.domain()[255])).attr("stop-opacity",
1);a.append("stop").attr("offset","0.5%").attr("stop-color",f(f.domain()[254])).attr("stop-opacity",1);a.append("stop").attr("offset","6.25%").attr("stop-color",f(f.domain()[240])).attr("stop-opacity",1);a.append("stop").attr("offset","12.5%").attr("stop-color",f(f.domain()[224])).attr("stop-opacity",1);a.append("stop").attr("offset","18.75%").attr("stop-color",f(f.domain()[208])).attr("stop-opacity",1);a.append("stop").attr("offset","25%").attr("stop-color",f(f.domain()[192])).attr("stop-opacity",
1);a.append("stop").attr("offset","31.25%").attr("stop-color",f(f.domain()[176])).attr("stop-opacity",1);a.append("stop").attr("offset","37.5%").attr("stop-color",f(f.domain()[160])).attr("stop-opacity",1);a.append("stop").attr("offset","43.75%").attr("stop-color",f(f.domain()[144])).attr("stop-opacity",1);a.append("stop").attr("offset","50%").attr("stop-color",f(f.domain()[128])).attr("stop-opacity",1);a.append("stop").attr("offset","56.25%").attr("stop-color",f(f.domain()[112])).attr("stop-opacity",
1);a.append("stop").attr("offset","62.5%").attr("stop-color",f(f.domain()[96])).attr("stop-opacity",1);a.append("stop").attr("offset","68.75%").attr("stop-color",f(f.domain()[80])).attr("stop-opacity",1);a.append("stop").attr("offset","75%").attr("stop-color",f(f.domain()[64])).attr("stop-opacity",1);a.append("stop").attr("offset","81.25%").attr("stop-color",f(f.domain()[48])).attr("stop-opacity",1);a.append("stop").attr("offset","87.5%").attr("stop-color",f(f.domain()[32])).attr("stop-opacity",1);
a.append("stop").attr("offset","93.75%").attr("stop-color",f(f.domain()[16])).attr("stop-opacity",1);a.append("stop").attr("offset","99.9%").attr("stop-color",f(f.domain()[1])).attr("stop-opacity",1);a.append("stop").attr("offset","100%").attr("stop-color",f(f.domain()[0])).attr("stop-opacity",1);c.append("g").attr("class","legend_group").append("rect").attr("class","legend").attr("width",20).attr("height",286).style("fill","url(#gradient)").attr("transform","translate(710,42.9)");a=[f.domain()[255],
f.domain()[192],f.domain()[128],f.domain()[64],f.domain()[0]];c.select("g.legend_group").selectAll(".labels").data(a).enter().append("text").text(function(a){return opec.utils.ceil3places(a)}).attr("class","labels").attr("transform",function(a,b){return"translate("+[735,71.5*(b-0.5)+85.8]+")"})}
...
opec.graphs.histogramChart=function(){function a(a){a.each(function(a){a=e(a);f.domain(a.map(function(a){return a.x})).rangeRoundBands([0,c-b.left-b.right],0.1);g.domain([0,d3.max(a,function(a){return a.y})]).range([d-b.top-b.bottom,0]);var i=d3.select(this).selectAll("svg").data([a]),j=i.enter().append("svg").append("g");j.append("g").attr("class","bars");j.append("g").attr("class","x axis");j.append("g").attr("class","y axis");i.attr("width",c).attr("height",d);j=i.select("g").attr("transform",
"translate("+b.left+","+b.top+")");a=i.select(".bars").selectAll(".bar").data(a);a.enter().append("rect");a.exit().remove();a.attr("width",f.rangeBand()).attr("x",function(a){return f(a.x)}).attr("y",function(a){return g(a.y)}).attr("height",function(a){return g.range()[0]-g(a.y)}).order();j.select(".x.axis").attr("transform","translate(0,"+g.range()[0]+")")})}var b={top:0,right:0,bottom:20,left:0},c=700,d=450,e=d3.layout.histogram(),f=d3.scale.ordinal(),g=d3.scale.linear(),i=d3.svg.axis().scale(f).orient("bottom").tickSize(6,
0);d3.svg.axis().scale(g).orient("left");a.margin=function(c){if(!arguments.length)return b;b=c;return a};a.width=function(b){if(!arguments.length)return c;c=b;return a};a.height=function(b){if(!arguments.length)return d;d=b;return a};d3.rebind(a,e,"value","range","bins");d3.rebind(a,i,"tickFormat");return a};opec.utils={};opec.utils.replace=function(a,b,c,d){var e=0,f=0,g="",i="",j=0,k=0,a=[].concat(a),b=[].concat(b),l=b instanceof Array,m=c instanceof Array,c=[].concat(c);d&&(this.window[d]=0);e=0;for(j=c.length;e<j;e++)if(""!==c[e]){f=0;for(k=a.length;f<k;f++)g=c[e]+"",i=l?void 0!==b[f]?b[f]:"":b[0],c[e]=g.split(a[f]).join(i),d&&c[e]!==g&&(this.window[d]+=(g.length-c[e].length)/a[f].length)}return m?c:c[0]};
opec.utils.arrayDeDupe=function(a){var b,c=a.length,d=[],e={};for(b=0;b<c;b++)e[a[b]]=0;for(b in e)d.push(b);return d};opec.utils.arrayRemove=function(a,b,c){c=a.slice((c||b)+1||a.length);a.length=0>b?a.length+b:b;return a.push.apply(a,c)};getNearestInArray=function(a,b){var c=null;$.each(a,function(a,e){if(null===c||Math.abs(e-b)<Math.abs(c-b))c=e});return c};opec.utils.ISODateString=function(a){function b(a){return 10>a?"0"+a:a}return a.getFullYear()+"-"+b(a.getMonth()+1)+"-"+b(a.getDate())};
...
$("#triggerL-buttonset").buttonset();$("#triggerL-add-accordion").button({label:"Add a new group",icons:{primary:"ui-icon-circle-plus"},text:!1}).click(function(){var a=$(".opec-tab-content:visible");opec.leftPanel.addNextGroupToPanel(a)});$("#triggerL-add-group").button();$("#lpanel-tabs").buttonset();$("#opec-lpanel-tab-operational").button();$("#opec-lpanel-tab-reference").button();$("#opec-lpanel-tab-options").button();$("#lpanel-tabs :button").click(function(){var a=$(this).attr("href");$("#opec-lPanel-content .opec-tab-content").filter(function(){return $(this).attr("id")!=
a.slice(1)}).hide("fast");$(a).show("fast")})};
...
opec.leftPanel.addLayerToGroup=function(a,b){if(!$("#"+a.name).length&&a.displayInLayerSwitcher){b.prepend(opec.templates.layer({name:a.name,visibility:a.visibility,displayTitle:a.displayTitle,type:a.controlID}));var c=$("#"+a.name);a.events.register("loadstart",a,function(){$("#"+this.name).find('img[src="img/ajax-loader.gif"]').show()});a.events.register("loadend",a,function(){$("#"+this.name).find('img[src="img/ajax-loader.gif"]').hide()});c.find('img[src="img/ajax-loader.gif"]').hide();c.find('img[src="img/exclamation_small.png"]').hide();
"baseLayers"!=a.controlID&&a.events.register("visibilitychanged",a,function(){opec.checkLayerState(a)})}};opec.leftPanel.removeLayerFromGroup=function(a){$("#"+a.name).length&&$("#"+a.name).remove()};opec.leftPanel.updateGroupOrder=function(a){$.each(a.find(".sensor-accordion"),function(){opec.leftPanel.updateLayerOrder($(this))})};
opec.leftPanel.updateLayerOrder=function(a){var b=0;$.each(a.parent("div").nextAll("div").children(".sensor-accordion"),function(){b+=$(this).children("li").length});var c=a.sortable("toArray");0<c.length&&$.each(c,function(a,e){var f=map.getLayersByName(e)[0];"undefined"!==typeof f&&map.setLayerIndex(f,("opLayers"==f.controlID?map.numBaseLayers:map.numBaseLayers+map.numOpLayers)+b+c.length-a-1)})};
...
opec.rightPanel.setup=function(){$(".triggerR").click(function(){$(".rPanel").toggle("fast");$(this).toggleClass("active");return!1});$("#opec-rPanel-content").children("div").multiOpenAccordion({active:[0,1]});$("#ROIButtonSet").buttonset();$("#point").button({icons:{primary:"ui-icon-drawpoint"}});$("#box").button({icons:{primary:"ui-icon-drawbox"}});$("#circle").button({icons:{primary:"ui-icon-drawcircle"}});$("#polygon").button({icons:{primary:"ui-icon-drawpoly"}});$("#dataTabs").tabs();$("#analyses").accordion({collapsible:!0,
heightStyle:"content"});$("#spatial").accordion({collapsible:!0,heightStyle:"content"});$("#temporal").accordion({collapsible:!0,heightStyle:"content"});opec.rightPanel.setupDrawingControls()};
opec.rightPanel.setupDrawingControls=function(){var a=new OpenLayers.Layer.Vector("POI Layer",{style:{strokeColor:"red",fillColor:"red",strokeWidth:2,fillOpacity:0.3,pointRadius:5},preFeatureInsert:function(){this.removeAllFeatures()},onFeatureInsert:function(a){var c=new OpenLayers.Geometry,c=a.geometry,a=new OpenLayers.Bounds,a=c.getBounds(),d,e,f,g,i,j,k,l=0;""!==map.ROI_Type&&"point"!=map.ROI_Type&&(c.getArea(),d=1E-6*c.getGeodesicArea(),e=a.getHeight(),f=a.getWidth(),l=c.getCentroid().x,k=c.getCentroid().y,
...
break;case "box":k=a;$("#graphcreator-bbox").size()&&$("#graphcreator-bbox").val(k.toBBOX(5,!1));$("#dispROI").html("<h3>Rectangular ROI</h4>");$("#dispROI").append('<canvas id="ROIC" width="100" height="100"></canvas>');c=document.getElementById("ROIC");c=c.getContext("2d");c.lineWidth=4;c.fillStyle="#CCCCCC";j=f>e?90/f:90/e;c.fillRect(5,5,f*j,e*j);c.strokeRect(5,5,f*j,e*j);$("#dispROI").append("<p>Width: "+f.toPrecision(4)+"&deg; ("+i.toPrecision(4)+" km)</p>");$("#dispROI").append("<p>Height: "+
e.toPrecision(4)+"&deg; ("+g.toPrecision(4)+" km)</p>");$("#dispROI").append("<p>Projected Area: "+d.toPrecision(4)+" km<sup>2</sup></p>");break;case "circle":$("#dispROI").html("<h3>Circular ROI</h4>");$("#dispROI").append('<img src="./img/circleROI.png" title ="Circular Region Of Interest" alt="Map Point" />');$("#dispROI").append("<p>Radius: "+j.toPrecision(4)+"&deg;</p>");$("#dispROI").append("<p>Centre lat, lon: "+k.toPrecision(4)+", "+l.toPrecision(4)+"</p>");$("#dispROI").append("<p>Width: "+
f.toPrecision(4)+"&deg; ("+i.toPrecision(4)+" km)</p>");$("#dispROI").append("<p>Height: "+e.toPrecision(4)+"&deg; ("+g.toPrecision(4)+" km)</p>");$("#dispROI").append("<p>Projected Area: "+d.toPrecision(4)+" km<sup>2</sup></p>");break;case "polygon":g=c.getVertices();$("#dispROI").html("<h3>Custom Polygon ROI</h4>");$("#dispROI").append('<canvas id="ROIC" width="100" height="100"></canvas>');c=document.getElementById("ROIC");c=c.getContext("2d");c.lineWidth=4;c.fillStyle="#CCCCCC";j=f>e?90/f:90/
e;c.beginPath();e=5+(g[0].x-a.left)*j;f=5+(a.top-g[0].y)*j;c.moveTo(e,f);i=1;for(var m=g.length;i<m;i++)c.lineTo(5+(g[i].x-a.left)*j,5+(a.top-g[i].y)*j);c.lineTo(e,f);c.stroke();c.fill();c.closePath();$("#dispROI").append("<p>Centroid Lat, Lon:"+k.toPrecision(4)+"&deg;, "+l.toPrecision(4)+"&deg;</p>");$("#dispROI").append("<p>Projected Area: "+d.toPrecision(4)+" km<sup>2</p>")}},rendererOptions:{zIndexing:!0}});a.controlID="poiLayer";a.displayInLayerSwitcher=!1;map.addLayer(a);opec.mapControls.point=
new OpenLayers.Control.DrawFeature(a,OpenLayers.Handler.Point);opec.mapControls.box=new OpenLayers.Control.DrawFeature(a,OpenLayers.Handler.RegularPolygon,{handlerOptions:{sides:4,irregular:!0,persist:!1}});opec.mapControls.circle=new OpenLayers.Control.DrawFeature(a,OpenLayers.Handler.RegularPolygon,{handlerOptions:{sides:50},persist:!1});opec.mapControls.polygon=new OpenLayers.Control.DrawFeature(a,OpenLayers.Handler.Polygon);map.addControls([opec.mapControls.point,opec.mapControls.box,opec.mapControls.circle,
opec.mapControls.polygon]);$("#ROIButtonSet input:radio").click(function(){opec.toggleControl(this);a.removeAllFeatures();map.ROI_Type=this.value});$("#panZoom label.ui-button, #ROIButtonSet label.ui-button").unbind("mousedown").unbind("mouseup").unbind("mouseover").unbind("mouseout").unbind("click",function(a){h.disabled&&(a.preventDefault(),a.stopImmediatePropagation())}).bind("mousedown",function(){$(this).addClass("opec_click")}).bind("mouseup",function(){$(this).hasClass("opec_click")&&$(this).click();
$(this).removeClass("opec_click")})};opec.contextMenu={};
opec.contextMenu.setup=function(){$.contextMenu.types.slider=function(a,b,c){$('<div id="'+a.id+'" class="context-menu slider"></div>').appendTo(this).on("click","> li",function(){console.log("Clicked on "+$(this).text());c.$menu.trigger("contextmenu:hide")}).slider({max:1,min:0,value:1,step:0.05,change:function(){map.getLayersByName($(".selectedLayer:visible").attr("id"))[0].setOpacity($("#"+a.id).slider("value"));return!0}});c.$menu.on("contextmenu:focus",function(){var b=map.getLayersByName($(".selectedLayer:visible").attr("id"))[0];("undefined"===
typeof b.opacity||null===b.opacity)&&b.setOpacity(1);$("#"+a.id).slider("value",b.opacity)})};$.contextMenu({selector:".selectedLayer",build:function(a){var b=map.getLayersByName($(".selectedLayer:visible").attr("id"))[0],c={fold1:{name:"Opacity",items:{opacitySlider:{type:"slider",customName:"Opacity Slider",id:"opacitySlider"}}}},d={fold3:{name:"Layer Styles",items:opec.contextMenu.getCurrentStyles(a)}},e={fold2:{name:"Layer Elevation",items:opec.contextMenu.getCurrentElevation(a)}},a={showScalebar:opec.contextMenu.showScalebar(a),
...
opec.contextMenu.viewData=function(a){var b="",c=null;a.attr("id")?(b=a.attr("id"),c=map.getLayersByName(b)[0]):(b=a.text(),c=map.microLayers[b]);return{name:"Zoom To Data",callback:function(){if(null!==c){var a=(new OpenLayers.Bounds(c.exBoundingBox.WestBoundLongitude,c.exBoundingBox.SouthBoundLatitude,c.exBoundingBox.EastBoundLongitude,c.exBoundingBox.NorthBoundLatitude)).transform(map.displayProjection,map.projection);map.zoomToExtent(a)}}}};
opec.contextMenu.showMetadata=function(a){var b="",c=null;a.attr("id")?(b=a.attr("id"),c=map.getLayersByName(b)[0]):(b=a.text(),c=map.microLayers[b]);return{name:"Show Metadata",callback:function(){opec.window.createMetadata(c)}}};opec.contextMenu.showScalebar=function(a){return{name:"Show Scalebar",callback:function(){opec.window.createScalebar(a)}}};
opec.contextMenu.getCurrentStyles=function(a){var b=map.getLayersByName(a.attr("id"))[0];if("opLayers"!=b.controlID)return[];var c=[],a=b.styles.slice();a.push({Name:"Remove Style",Abstract:"",LegendURL:"",Width:0,Height:0});$.each(a,function(a,e){c["Layer Styles"+a]={name:e.Name,className:e.Name==b.params.STYLES?"styleSelected":"",callbackName:"Layer Styles "+e.Name,callback:function(){var a=map.getLayersByName($(".selectedLayer:visible").attr("id"))[0];a.mergeNewParams({styles:"Remove Style"==e.Name?
"":e.Name});console.log(e.Name);updateScalebar(a)}}});return c};opec.contextMenu.getCurrentElevation=function(a){var b=map.getLayersByName(a.attr("id"))[0],c=[];$.each(b.elevationCache,function(a,e){c["Layer Elevation "+a]={name:parseFloat(e).toFixed(3)+" "+b.elevationUnits,className:e==b.params.ELEVATION?"elevationSelected":"",callbackName:"Layer Elevation "+e,callback:function(){map.getLayersByName($(".selectedLayer:visible").attr("id"))[0].mergeNewParams({elevation:e})}}});return c};
opec.contextMenu.showGraphCreator=function(){return{name:"Show Graph Creator",callback:function(){opec.window.createGraphCreator()}}};OpenLayers.Map.prototype.host="";OpenLayers.Map.prototype.pywcsLocation="/alphaservice/wcs2json/wcs?";OpenLayers.Map.prototype.pywfsLocation="/alphaservice/wfs2json/wfs?";OpenLayers.Map.prototype.cesiumLoaded=null;OpenLayers.Map.prototype.sampleLayers=["no3","chl","v_wind","CRW_SST"];OpenLayers.Map.prototype.enabledDays=[];OpenLayers.Map.prototype.getCapabilities=[];OpenLayers.Map.prototype.numBaseLayers=0;OpenLayers.Map.prototype.numRefLayers=0;OpenLayers.Map.prototype.numOpLayers=0;
OpenLayers.Map.prototype.helperMessages=[];OpenLayers.Map.prototype.microLayers=[];OpenLayers.Map.prototype.layerStore=[];OpenLayers.Map.prototype.ROI_Type="";OpenLayers.Layer.prototype.urlName="";OpenLayers.Layer.prototype.displayTitle="";OpenLayers.Layer.prototype.title="";OpenLayers.Layer.prototype.productAbstract="";OpenLayers.Layer.prototype.displaySensorName="";OpenLayers.Layer.prototype.sensorName="";OpenLayers.Layer.prototype.firstDate="";OpenLayers.Layer.prototype.lastDate="";
...
OpenLayers.Layer.prototype.matchDate=function(a){var b=$.grep(this.DTCache,function(b){return b.substring(0,10)==a});return 0<b.length?b:null};
...
OpenLayers.Map.prototype.getLayerData=function(a,b){$.ajax({type:"GET",url:"./cache/layers/"+a,dataType:"json",asyc:!0,cache:!1,success:function(a){opec.createOpLayer(a,b);opec.addOpLayer(b.name)},error:function(a,b,e){gritterErrorHandler({type:"layer cache",request:a,errorType:b,exception:e,url:this.url})}})};
...
var d=d3.min(this.timebars,function(a){return new Date(a.startDate)}),e=d3.max(this.timebars,function(a){return new Date(a.endDate)});if("undefined"===typeof d||null===d)d=new Date(this.selectedDate.getTime()-1577845E4);if("undefined"===typeof e||null===e)e=new Date(this.selectedDate.getTime()+1577845E4);this.xScale=d3.time.scale().domain([d,e]).range([0,this.width]);this.yScale=d3.scale.linear().domain([0,this.timebars.length]).range([0,this.height]);this.clickDate=function(){var a=d3.event.layerX,
...
b.alpha=1,b.show=a.getVisibility());return b}},removeLayer:function(a){for(var b=this.cb.getImageryLayers(),c=0,d=b.getLength();c<d;c++){var e=b.get(c);if(e.getImageryProvider()instanceof Cesium.WebMapServiceImageryProvider&&e.getImageryProvider().getUrl()==a.url){this.cb.getImageryLayers().remove(e,!1);break}}},pan:function(a,b){var c={};c.startPosition=new Cesium.Cartesian2(0,0);c.endPosition=new Cesium.Cartesian2(a,b);c.motion=new Cesium.Cartesian2(0,0);this.scene.getCamera().getControllers().get(0)._spin(c)},
getMaxExtent:function(){return new OpenLayers.Bounds(-45,-45,45,45)},getExtent:function(){var a=this.getLonLatFromPixel({x:this.canvas.width/2,y:this.canvas.height/2}),b=this.getLonLatFromPixel({x:this.canvas.width/2,y:0}),c=this.getLonLatFromPixel({x:this.canvas.width,y:this.canvas.height/2}),d=this.getLonLatFromPixel({x:this.canvas.width/2,y:this.canvas.height}),e=this.getLonLatFromPixel({x:0,y:this.canvas.height/2});-1E3==e.lon&&(e={lat:a.lat,lon:a.lon-45},c={lat:a.lat,lon:a.lon+45});-1E3==b.lat&&
(b={lat:a.lat+45,lon:a.lon},d={lat:a.lat-45,lon:a.lon});return new OpenLayers.Bounds(e.lon,d.lat,c.lon,b.lat)},zoomIn:function(){},zoomOut:function(){},zoomToMaxExtent:function(){},zoomToExtent:function(a){a instanceof OpenLayers.Bounds||(a=new OpenLayers.Bounds(a));var b=Cesium.Math.toRadians(a.left),c=Cesium.Math.toRadians(a.bottom),d=Cesium.Math.toRadians(a.right),a=Cesium.Math.toRadians(a.top);this.scene.getCamera().viewExtent(new Cesium.Extent(b,c,d,a),this.ellipsoid)},setBaseLayer:function(a){var b=
null,c=null;if(null!==this.currentBaseLayer&&this.currentBaseLayer.getImageryProvider().getUrl()!=a.url){for(var d=0,e=this.baseLayers.length;d<e;d++)a.url==this.baseLayers[d].getImageryProvider().getUrl()&&(this.cb.getImageryLayers().add(this.baseLayers[d],0),b=this.baseLayers[d],c=d);this.baseLayers.splice(c,1);this.cb.getImageryLayers().remove(this.currentBaseLayer,!1);this.baseLayers.push(this.currentBaseLayer);this.currentBaseLayer=b}}},OpenLayers.Map.prototype.setupGlobe=function(a,b,c){this.globe.initialise(a,
...
typeof c&&(c={text:c});if(!c.text)throw'You must supply "text" parameter.';this._is_setup||this._runSetup();var d=c.title,e=c.text,f=c.image||"",g=c.sticky||!1,i=c.class_name||a.gritter.options.class_name,j=a.gritter.options.position,k=c.time||"";this._verifyWrapper();this._groups[c.group]?this._groups[c.group].count++:(this._groups[c.group]={},this._groups[c.group].count=1,this._groups[c.group].uid=[]);if(this._groups[c.group].count>c.max)return this._groups[c.group].count--,null;this._item_count++;
var l=this._item_count,m=this._tpl_item;a(["before_open","after_open","before_close","after_close"]).each(function(d,e){b["_"+e+"_"+l]=a.isFunction(c[e])?c[e]:function(){}});this._custom_timer=0;k&&(this._custom_timer=k);k=""!=f?'<img src="'+f+'" class="gritter-image" />':"";f=""!=f?"gritter-with-image":"gritter-without-image";d=d?this._str_replace("[[title]]",d,this._tpl_title):"";m=this._str_replace("[[title]] [[text]] [[close]] [[image]] [[number]] [[class_name]] [[item_class]]".split(" "),[d,
e,this._tpl_close,k,this._item_count,f,i],m);if(!1===this["_before_open_"+l]())return!1;a("#gritter-notice-wrapper").addClass(j).append(m);d=a("#gritter-item-"+this._item_count);d.fadeIn(this.fade_in_speed,function(){b["_after_open_"+l](a(this))});g||this._setFadeTimer(d,l);a(d).bind("mouseenter mouseleave",function(c){"mouseenter"==c.type?g||b._restoreItemIfFading(a(this),l):g||b._setFadeTimer(a(this),l);b._hoverState(a(this),c.type)});a(d).find(".gritter-close").click(function(){b.removeSpecific(c.group,
{},null,!0)});this._groups[c.group].uid.push(l);return c.group},_countRemoveWrapper:function(b,d,e){d.remove();this["_after_close_"+b](d,e);0==a(".gritter-item-wrapper").length&&a("#gritter-notice-wrapper").remove()},_fade:function(a,d,e,f){var g=e||{},e="undefined"!=typeof g.fade?g.fade:!0,g=g.speed||this.fade_out_speed;this["_before_close_"+d](a,f);f&&a.unbind("mouseenter mouseleave");e?a.animate({opacity:0},g,function(){a.animate({height:0},300,function(){b._countRemoveWrapper(d,a,f)})}):this._countRemoveWrapper(d,
a)},_hoverState:function(a,b){"mouseenter"==b?(a.addClass("hover"),a.find(".gritter-close").show()):(a.removeClass("hover"),a.find(".gritter-close").hide())},removeSpecific:function(b,d,e,f){var g=this._groups[b].uid.shift();this._groups[b].count--;e||(e=a("#gritter-item-"+g));this._fade(e,g,d||{},f)},_restoreItemIfFading:function(a,b){clearTimeout(this["_int_id_"+b]);a.stop().css({opacity:"",height:""})},_runSetup:function(){for(var b in a.gritter.options)this[b]=a.gritter.options[b];this._is_setup=
1},_setFadeTimer:function(a,d){this["_int_id_"+d]=setTimeout(function(){b._fade(a,d)},this._custom_timer?this._custom_timer:this.time)},stop:function(b){var d=a.isFunction(b.before_close)?b.before_close:function(){},e=a.isFunction(b.after_close)?b.after_close:function(){},b=a("#gritter-notice-wrapper");d(b);b.fadeOut(function(){a(this).remove();e()})},_str_replace:function(a,b,e,f){var g=0,i=0,j="",k="",l=0,m=0,a=[].concat(a),b=[].concat(b),n=b instanceof Array,p=e instanceof Array,e=[].concat(e);
f&&(this.window[f]=0);g=0;for(l=e.length;g<l;g++)if(""!==e[g]){i=0;for(m=a.length;i<m;i++)j=e[g]+"",k=n?void 0!==b[i]?b[i]:"":b[0],e[g]=j.split(a[i]).join(k),f&&e[g]!==j&&(this.window[f]+=(j.length-e[g].length)/a[i].length)}return p?e:e[0]},_verifyWrapper:function(){0==a("#gritter-notice-wrapper").length&&a("body").append(this._tpl_wrap)}}})(jQuery);
