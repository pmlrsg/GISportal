...
!0;a.popup=b;map.addPopup(b)},featureunselected:function(a){a=a.feature;map.removePopup(a.popup);a.popup.destroy();a.popup=null}}},{typeName:b.name,format:"image/png",transparent:!0,exceptions:"XML",version:"1.0",layers:"1"});opec.mapControls.selector.setLayer(d);if(b.times.length){d.temporal=!0;for(var e=[],l={},m=0;m<b.times.length;m++){var n=b.times[m];e.push(n.startdate);l[n.startdate]=n.id}d.DTCache=e;d.WFSDatesToIDs=l}d.urlName=b.name.replace("-",":");d.controlID="refLayers";d.setVisibility(!1);
...
opec.contextMenu.showGraphCreator=function(){return{name:"Show Graph Creator",callback:function(){opec.window.createGraphCreator()}}};OpenLayers.Map.prototype.host="";OpenLayers.Map.prototype.pywcsLocation="/service/wcs2json/wcs?";OpenLayers.Map.prototype.pywfsLocation="/service/wfs2json/wfs?";OpenLayers.Map.prototype.cesiumLoaded=null;OpenLayers.Map.prototype.sampleLayers=["no3","chl","v_wind","CRW_SST"];OpenLayers.Map.prototype.enabledDays=[];OpenLayers.Map.prototype.getCapabilities=[];OpenLayers.Map.prototype.numBaseLayers=0;OpenLayers.Map.prototype.numRefLayers=0;OpenLayers.Map.prototype.numOpLayers=0;
