	...
	var methods = {
      ...
      "help": function() {
		...
		"_initButtons" : function(){
			...
			function createButton(text, icon, classes) {
			...
			$(buttonPane)		
            .append(createButton(settings.buttons.help.text, settings.buttons.help.icon, 'ui-dialog-titlebar-help'))
            .append(createButton(settings.buttons.minimize.text, settings.buttons.minimize.icon, 'ui-dialog-titlebar-minimize'))
            .append(createButton(settings.buttons.restore.text, settings.buttons.restore.icon, 'ui-dialog-titlebar-restore'))
				.append(createButton(settings.buttons.maximize.text, settings.buttons.maximize.icon, 'ui-dialog-titlebar-maximize'))

				// add effect to buttons
				.find(".ui-dialog-titlebar-maximize,.ui-dialog-titlebar-minimize,.ui-dialog-titlebar-restore,.ui-dialog-titlebar-help")
					//.attr("role", "button")
		...
		"_initStyles" : function(){
			...
			if ( !$(".dialog-extend-css").length ) {
				...
				style += '.ui-dialog .ui-dialog-titlebar-help,';
				style += '.ui-dialog .ui-dialog-titlebar-close,';
				style += '.ui-dialog .ui-dialog-titlebar-restore { width: 21px; padding: 1px; height: 20px; }';
