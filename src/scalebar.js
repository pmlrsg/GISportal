...
gisportal.scalebars.autoScale = function(id, force)  {
   ...
   try{
      ...
      $.ajax({
         url: gisportal.ProxyHost + encodeURIComponent(l.wmsURL + 'item=minmax&layers=' + l.urlName + '&bbox=' + bbox + '&elevation=' + (l.selectedElevation || -1) + '&time='+ new Date(l.selectedDateTime).toISOString() + '&crs=' + gisportal.lonlat + '&srs=' + gisportal.lonlat + '&width=50&height=50&request=GetMetadata'),
         dataType: 'json',
