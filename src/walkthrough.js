   ...
   this.chapters = [
   	{
   		...
   		'steps' : [
		      ...
		      },
		      {
		         id : 6,
		         prev : 5,
		         content: '<p>Step 6. Use the timeline at the bottom to quickly see the dates for which there is data available. See \'Overview of the timeline\' for help on how to use.</p>',
		         binding: '#timeline'
		      }
   		]
   	},
