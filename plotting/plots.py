...
from data_extractor.extractors import BasicExtractor, IrregularExtractor, TransectExtractor, SingleExtractor, UniversalExtractor
...
"""
   ...
   if opts.command == "execute":
      ...
      # request = json.loads('{"plot": {"style": "boxfill/alg", "downloadTypes": [{"key": "csv", "label": "CSV"}, {"key": "png", "label": "PNG"}, {"key": "meta-data", "label": "Meta Data"}, {"key": "logos", "label": "Logos"}, {"key": "svg", "label": "SVG"}], "title": "Plymouth_Marine_Laboratory: Bias of Absorption Coefficient for Dissolved and Detrital Material at 412 Nm.", "transectFile": "/local1/data/scratch/nik/GISportal/uploads/cache/124e9643b54436602b9a5c3af74a1aba.csv", "data": {"series": [{"data_source": {"layer_id": "adg_412_bias__Plymouth_Marine_Laboratory2", "threddsUrl": "https://rsg.pml.ac.uk/thredds/wcs/CCI_ALL-v3.0-DAILY", "t_bounds": ["1997-09-04", "2015-12-30"], "bbox": "GEOMETRYCOLLECTION(POINT(-67.236328 23.725012),POINT(-62.490234 25.165173),POINT(-61.611328 26.902477),POINT(-41.154785 34.452218),POINT(-39.353027 34.849875),POINT(-37.111816 35.424868),POINT(-32.277832 38.993572),POINT(-29.553223 40.747257),POINT(-27.04834 41.640078),POINT(-24.411621 42.650122),POINT(-22.609863 43.452919),POINT(-18.654785 44.621754),POINT(-12.634277 46.769968),POINT(-8.986816 48.341646),POINT(-8.195801 48.719961),POINT(-7.536621 49.15297),POINT(-6.833496 49.496675),POINT(-6.04248 49.639177),POINT(-4.855957 49.781264),POINT(-4.724121 50.007739),POINT(-4.575806 50.057139),POINT(-4.312134 50.205033))", "coverage": "adg_412_bias"}, "yAxis": 1, "label": "1) Bias of Absorption Coefficient for Dissolved and Detrital Material at 412 Nm. - Plymouth Marine Laboratory", "handler": "OPEC_SERVICE_WCS", "meta": "Region: undefined<br>Confidence: undefined<br>Provider: Plymouth_Marine_Laboratory<br>Interval: undefined<br>Bounding Box: GEOMETRYCOLLECTION(POINT(-67.236328 23.725012),POINT(-62.490234 25.165173),POINT(-61.611328 26.902477),POINT(-41.154785 34.452218),POINT(-39.353027 34.849875),POINT(-37.111816 35.424868),POINT(-32.277832 38.993572),POINT(-29.553223 40.747257),POINT(-27.04834 41.640078),POINT(-24.411621 42.650122),POINT(-22.609863 43.452919),POINT(-18.654785 44.621754),POINT(-12.634277 46.769968),POINT(-8.986816 48.341646),POINT(-8.195801 48.719961),POINT(-7.536621 49.15297),POINT(-6.833496 49.496675),POINT(-6.04248 49.639177),POINT(-4.855957 49.781264),POINT(-4.724121 50.007739),POINT(-4.575806 50.057139),POINT(-4.312134 50.205033))<br>", "type": "line"}]}, "isIrregular": "true", "matchup_log": false, "xAxis": {"scale": "linear", "tickFormat": ",.2f", "ticks": "auto", "weight": "auto", "label": "Date/Time"}, "y1Axis": {"scale": "linear", "tickFormat": "auto", "ticks": "auto", "weight": "auto", "label": "Bias of Absorption Coefficient for Dissolved and Detrital Material at 412 Nm. (m-1)"}, "type": "transect"}, "style": {"logos": []}}')

      # Timeseries bbox:
      # request = json.loads('{"plot": {"style": "boxfill/alg", "downloadTypes": [{"key": "csv", "label": "CSV"}, {"key": "png", "label": "PNG"}, {"key": "meta-data", "label": "Meta Data"}, {"key": "logos", "label": "Logos"}, {"key": "svg", "label": "SVG"}], "title": "Plymouth_Marine_Laboratory: Mass Concentration of Chlorophyll a in Sea Water", "data": {"series": [{"data_source": {"layer_id": "chlor_a__Plymouth_Marine_Laboratory2", "threddsUrl": "https://rsg.pml.ac.uk/thredds/wcs/CCI_ALL-v3.0-DAILY", "t_bounds": ["2015-12-28", "2015-12-30"], "bbox": "-179.9791717529297,-89.97916412353516,179.9791717529297,89.97916412353516", "coverage": "chlor_a"}, "yAxis": 1, "label": "1) Mass Concentration of Chlorophyll a in Sea Water - Plymouth Marine Laboratory", "handler": "OPEC_SERVICE_WCS", "meta": "Region: undefined<br>Confidence: undefined<br>Provider: Plymouth_Marine_Laboratory<br>Interval: undefined<br>Bounding Box: -179.9791717529297,-89.97916412353516,179.9791717529297,89.97916412353516<br>", "type": "line"}]}, "matchup_log": false, "xAxis": {"scale": "linear", "tickFormat": "%d/%m/%Y", "ticks": "auto", "weight": "auto", "label": "Date/Time"}, "y1Axis": {"scale": "log", "tickFormat": "auto", "ticks": "auto", "weight": "auto", "label": "Mass Concentration of Chlorophyll a in Sea Water (milligram m-3)"}, "type": "timeseries"}, "style": {"logos": []}}')
      # Timeseries polygon:
      # request = json.loads('{"plot":{"type":"timeseries","title":"Plymouth_Marine_Laboratory: Mass Concentration of Chlorophyll a in Sea Water","style":"boxfill/alg","downloadTypes":[{"key":"csv","label":"CSV"},{"key":"png","label":"PNG"},{"key":"meta-data","label":"Meta Data"},{"key":"logos","label":"Logos"},{"key":"svg","label":"SVG"}],"matchup_log":false,"xAxis":{"scale":"linear","label":"Date/Time","ticks":"auto","weight":"auto","tickFormat":"%d/%m/%Y"},"y1Axis":{"scale":"log","label":"Mass Concentration of Chlorophyll a in Sea Water (milligram m-3)","ticks":"auto","weight":"auto","tickFormat":"auto"},"data":{"series":[{"handler":"OPEC_SERVICE_WCS","data_source":{"coverage":"chlor_a","layer_id":"chlor_a__Plymouth_Marine_Laboratory1","t_bounds":["2015-12-20","2015-12-27"],"bbox":"POLYGON((-79.541 17.578,-57.041 65.391,-48.252 38.145,-15.732 38.496,-2.725 65.742,18.721 17.402,-30.85 -35.684,-79.541 17.578))","threddsUrl":"https://rsg.pml.ac.uk/thredds/wcs/CCI_ALL-v3.0-DAILY"},"label":"1) Mass Concentration of Chlorophyll a in Sea Water - Plymouth Marine Laboratory","yAxis":1,"type":"line","meta":"Region: undefined<br>Confidence: undefined<br>Provider: Plymouth_Marine_Laboratory<br>Interval: undefined<br>Bounding Box: Gitlab<br>"}]},"isIrregular":"true"},"style":{"logos":[]}}')
      # Transect:
      # request = json.loads('{"plot": {"style": "boxfill/alg", "downloadTypes": [{"key": "csv", "label": "CSV"}, {"key": "png", "label": "PNG"}, {"key": "meta-data", "label": "Meta Data"}, {"key": "logos", "label": "Logos"}, {"key": "svg", "label": "SVG"}], "title": "Plymouth_Marine_Laboratory: Mass Concentration of Chlorophyll a in Sea Water", "transectFile": "/local1/data/scratch/nik/GISportal/uploads/cache/423133c01e913d268ff311e513bcc823.csv", "data": {"series": [{"data_source": {"layer_id": "chlor_a__Plymouth_Marine_Laboratory3", "threddsUrl": "https://rsg.pml.ac.uk/thredds/wcs/CCI_ALL-v3.0-MONTHLY", "t_bounds": ["1997-09-04", "2015-12-01"], "bbox": "GEOMETRYCOLLECTION(POINT(-69.169922 22.43134),POINT(-67.236328 23.725012),POINT(-63.369141 24.686952),POINT(-62.490234 25.165173),POINT(-61.611328 26.902477),POINT(-60.908203 28.149503),POINT(-60.205078 28.459033),POINT(-59.611816 28.690588),POINT(-59.040527 28.22697),POINT(-57.810059 28.767659),POINT(-57.502441 29.22889),POINT(-56.66748 29.764377),POINT(-56.228027 29.496988),POINT(-54.909668 30.069094),POINT(-54.118652 30.86451),POINT(-53.239746 30.675715),POINT(-52.932129 30.562261),POINT(-50.075684 31.316101),POINT(-48.713379 31.653381),POINT(-47.043457 32.249974),POINT(-45.900879 32.731841),POINT(-45.285645 33.063924),POINT(-44.494629 33.321349),POINT(-43.879395 33.578015),POINT(-42.956543 33.906896),POINT(-41.989746 34.198173),POINT(-41.154785 34.452218),POINT(-40.187988 34.633208),POINT(-39.353027 34.849875),POINT(-38.430176 35.065973),POINT(-37.111816 35.424868),POINT(-36.452637 35.603719),POINT(-35.529785 35.817813),POINT(-34.73877 36.173357),POINT(-34.211426 36.738884),POINT(-33.771973 37.160317),POINT(-33.156738 37.579413),POINT(-32.277832 38.993572),POINT(-31.311035 39.943436),POINT(-30.695801 40.279526),POINT(-30.212402 40.413496),POINT(-29.553223 40.747257),POINT(-28.718262 41.013066),POINT(-27.751465 41.310824),POINT(-27.04834 41.640078),POINT(-26.520996 41.836828),POINT(-25.905762 42.065607),POINT(-25.202637 42.358544),POINT(-24.411621 42.650122),POINT(-24.147949 42.747012),POINT(-23.181152 43.100983),POINT(-22.609863 43.452919),POINT(-21.203613 44.056012),POINT(-19.841309 44.527843),POINT(-19.138184 44.684277),POINT(-18.654785 44.621754),POINT(-17.995605 44.715514),POINT(-17.248535 45.02695),POINT(-16.589355 45.274886),POINT(-15.622559 45.243953),POINT(-15.13916 45.552525),POINT(-14.699707 45.828799),POINT(-13.996582 46.164614),POINT(-13.425293 46.346928),POINT(-12.634277 46.769968),POINT(-12.194824 47.040182),POINT(-11.711426 47.279229),POINT(-11.008301 47.606163),POINT(-10.349121 47.872144),POINT(-9.51416 48.107431),POINT(-8.986816 48.341646),POINT(-8.195801 48.719961),POINT(-7.536621 49.15297),POINT(-6.833496 49.496675),POINT(-6.04248 49.639177),POINT(-5.075684 49.667628),POINT(-4.855957 49.781264),POINT(-4.724121 50.007739),POINT(-4.575806 50.057139),POINT(-4.312134 50.205033),POINT(-4.136353 50.289339))", "coverage": "chlor_a"}, "yAxis": 1, "label": "1) Mass Concentration of Chlorophyll a in Sea Water - Plymouth Marine Laboratory", "handler": "OPEC_SERVICE_WCS", "meta": "Region: undefined<br>Confidence: undefined<br>Provider: Plymouth_Marine_Laboratory<br>Interval: Monthly<br>Bounding Box: GEOMETRYCOLLECTION(POINT(-69.169922 22.43134),POINT(-67.236328 23.725012),POINT(-63.369141 24.686952),POINT(-62.490234 25.165173),POINT(-61.611328 26.902477),POINT(-60.908203 28.149503),POINT(-60.205078 28.459033),POINT(-59.611816 28.690588),POINT(-59.040527 28.22697),POINT(-57.810059 28.767659),POINT(-57.502441 29.22889),POINT(-56.66748 29.764377),POINT(-56.228027 29.496988),POINT(-54.909668 30.069094),POINT(-54.118652 30.86451),POINT(-53.239746 30.675715),POINT(-52.932129 30.562261),POINT(-50.075684 31.316101),POINT(-48.713379 31.653381),POINT(-47.043457 32.249974),POINT(-45.900879 32.731841),POINT(-45.285645 33.063924),POINT(-44.494629 33.321349),POINT(-43.879395 33.578015),POINT(-42.956543 33.906896),POINT(-41.989746 34.198173),POINT(-41.154785 34.452218),POINT(-40.187988 34.633208),POINT(-39.353027 34.849875),POINT(-38.430176 35.065973),POINT(-37.111816 35.424868),POINT(-36.452637 35.603719),POINT(-35.529785 35.817813),POINT(-34.73877 36.173357),POINT(-34.211426 36.738884),POINT(-33.771973 37.160317),POINT(-33.156738 37.579413),POINT(-32.277832 38.993572),POINT(-31.311035 39.943436),POINT(-30.695801 40.279526),POINT(-30.212402 40.413496),POINT(-29.553223 40.747257),POINT(-28.718262 41.013066),POINT(-27.751465 41.310824),POINT(-27.04834 41.640078),POINT(-26.520996 41.836828),POINT(-25.905762 42.065607),POINT(-25.202637 42.358544),POINT(-24.411621 42.650122),POINT(-24.147949 42.747012),POINT(-23.181152 43.100983),POINT(-22.609863 43.452919),POINT(-21.203613 44.056012),POINT(-19.841309 44.527843),POINT(-19.138184 44.684277),POINT(-18.654785 44.621754),POINT(-17.995605 44.715514),POINT(-17.248535 45.02695),POINT(-16.589355 45.274886),POINT(-15.622559 45.243953),POINT(-15.13916 45.552525),POINT(-14.699707 45.828799),POINT(-13.996582 46.164614),POINT(-13.425293 46.346928),POINT(-12.634277 46.769968),POINT(-12.194824 47.040182),POINT(-11.711426 47.279229),POINT(-11.008301 47.606163),POINT(-10.349121 47.872144),POINT(-9.51416 48.107431),POINT(-8.986816 48.341646),POINT(-8.195801 48.719961),POINT(-7.536621 49.15297),POINT(-6.833496 49.496675),POINT(-6.04248 49.639177),POINT(-5.075684 49.667628),POINT(-4.855957 49.781264),POINT(-4.724121 50.007739),POINT(-4.575806 50.057139),POINT(-4.312134 50.205033),POINT(-4.136353 50.289339))<br>", "type": "line"}]}, "isIrregular": "true", "matchup_log": false, "xAxis": {"scale": "linear", "tickFormat": ",.2f", "ticks": "auto", "weight": "auto", "label": "Date/Time"}, "y1Axis": {"scale": "log", "tickFormat": "auto", "ticks": "auto", "weight": "auto", "label": "Mass Concentration of Chlorophyll a in Sea Water (milligram m-3)"}, "type": "transect"}, "style": {"logos": []}}')
      # Load from a file:
      # with open('/home/nik/scratch_local/GISportal/html/plots/04e1811266a7c081c1874bbd7a682feea3847a69-request.json') as request_file:
      #    request = json.load(request_file)
